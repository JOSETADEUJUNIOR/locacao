...
class Template
{
    ...
    private function helpers(): void
    {
        array(
            ...
            $this->twig->addFunction(
                new \Twig\TwigFunction('contarTempoRestante', function (string $data) {
                            return Helpers::calcularTempoDevolucao($data);
                        })
        ),
        $this->twig->addFunction(
            new \Twig\TwigFunction('calcularTempoRestante', function (string $data) {
                        return Helpers::calcularTempoRestante($data);
                    })
    ),
            $this->twig->addFunction(
