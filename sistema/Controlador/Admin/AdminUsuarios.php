...
class AdminUsuarios extends AdminControlador
{
    ...
    public function validarDados(array $dados): bool
    {
        if (empty(trim($dados['nome']))) {
            Helpers::json('erro', 'Informe o nome do usuario!');
          
        }
       
        if (empty(trim($dados['email']))) {
            Helpers::json('erro', 'Informe o email do usuario!');
        }
        if (empty(trim($dados['telefone']))) {
            Helpers::json('erro', 'Informe o telefone do usuario!');
        }
        if (!Helpers::validarEmail($dados['email'])) {
            Helpers::json('erro', 'Informe um e-mail valido!');
        }
